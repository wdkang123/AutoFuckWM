...
class LoginBySMS:
    ...
    def exchange_secret(self):
        ...
        resp = requests.post(
            ...
            headers={
                "User-Agent":
                "Dalvik/2.1.0 (Linux; U; Android 9; HUAWEI INE-AL00 Build/HUAWEIINE-AL00)",
            },
    ...
    def sendSMS(self):
        ...
        upload_args = {'session': self.user_info['sessionId'], 'data': data}
    ...
    # wdkang123 新增
    def get_device(self):
      return self.user_info['deviceId']
