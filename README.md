# 完美校园自动打卡(于2021年已停止维护) - autofuck
:blush: 完美校园自动打卡(于2021年已停止维护)
<br />
<br />
:star: 限于简化日常烦躁打卡
<br />
...
**如果大家和我们学校一样 打卡项目经常变化的话 可以试试哦！**

其实我主要想的是 模仿完美那样 但也不用上纲上线成APP 让完全没有基础的人 也能使用服务

（但这要求 编写者和提供服务者 技术要有）

集成了Flask提供web服务

登录时 向完美接口请求需要打卡的内容 和 上次打卡的信息 并渲染到web中

接着 填写好后 点击提交 会存入mysql服务器中

第二天将会从mysql中取信息后打卡

（我代码写的是“代码屎山”）

大家可以参考实现逻辑 实现自己的需要的部分！



**如果大家的打卡项目变动不大的话**

我还是推荐 github上很多开源的方法 通过Actions等方式 
